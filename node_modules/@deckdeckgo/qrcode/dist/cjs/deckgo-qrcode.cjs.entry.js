...
const index = require('./index-a67502bc.js');
...
const DeckdeckgoQRCode = class {
  ...
  render() {
    return (index.h("div", { class: "deckgo-qrcode-container" }, index.h("slot", { name: "logo" })));
  }
...
DeckdeckgoQRCode.style = deckdeckgoQrcodeCss;

exports.deckgo_qrcode = DeckdeckgoQRCode;
